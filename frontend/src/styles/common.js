...
export const cardClass =
  "bg-[#f5f5f7] rounded-2xl p-7 hover:bg-[#ebebf0] hover:-translate-y-1 transition-all duration-200 cursor-pointer";
...
export const articleCardClass =
  "bg-[#f5f5f7] p-7 rounded-2xl hover:bg-[#ebebf0] hover:-translate-y-1 transition-all duration-200 flex flex-col gap-2.5 cursor-pointer";
export const articleTitle =
  "text-lg font-semibold text-[#1d1d1f] leading-snug tracking-tight hover:text-[#0066cc] transition-colors";
...
export const articleContent =
  "text-[#1d1d1f] leading-[2] text-[1.05rem] whitespace-pre-line mt-8";
